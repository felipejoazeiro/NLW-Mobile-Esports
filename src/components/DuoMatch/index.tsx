...
import { Modal, Text, View, ModalProps, TouchableOpacity, Alert, ActivityIndicator } from 'react-native'
...
export function DuoMatch({discord, onClose,...rest}: Props) {
    ...
    async function handleCopyDiscordToClipboard(){
      ...
      Alert.alert("Discord Copiado!", 'Usuário copiado para sua área de transferência! Cole no discord.')
      setIsCopping(false)
    }
